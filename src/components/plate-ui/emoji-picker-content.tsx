      ...
      .map(({ id: categoryId }) => {
        ...
        return (
          <div
            ...
            data-id={categoryId}
          >
            <div className="sticky -top-px z-1 bg-white/90 p-1 py-2 text-sm font-semibold backdrop-blur-xs dark:bg-neutral-950/90">
  ...
  const SearchList = useCallback(() => {
    return (
      <div style={{ width: getRowWidth }} data-id="search">
        <div className="sticky -top-px z-1 bg-white/90 p-1 py-2 text-sm font-semibold text-neutral-950 backdrop-blur-xs dark:bg-neutral-950/90 dark:text-neutral-50">
          {i18n.searchResult}
        </div>
