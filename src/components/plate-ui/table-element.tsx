  ...
  ({ children, ...props }, ref) => {
    ...
    return (
      <Popover open={canMerge || canSplit || collapsed} modal={false}>
        ...
        >
          <Toolbar
            className="flex scrollbar-hide w-auto max-w-[80vw] flex-row overflow-x-auto rounded-md border border-neutral-200 bg-white p-1 shadow-md print:hidden dark:border-neutral-800 dark:bg-neutral-950"
            contentEditable={false}
          >
            <ToolbarGroup>
              {canMerge && (
